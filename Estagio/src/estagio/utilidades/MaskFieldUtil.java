...
public abstract class MaskFieldUtil
{
    ...
    public static void yearField(final TextField textField)
    {
    ...
    {
        MaskFieldUtil.maxField(textField, 12);
        textField.lengthProperty().addListener((observableValue, number, number2) ->
        {
            String value = textField.getText();
            value = value.replaceAll("[^0-9]", "");
    ...
    public static void onlyDigitsValue2(TextField textField)
    {
    ...
    public static void onlyLettersValue(TextField textField)
    {
        textField.lengthProperty().addListener((observableValue, number, number2) ->
        {
            String value = textField.getText();
